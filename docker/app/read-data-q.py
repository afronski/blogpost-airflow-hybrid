...
if __name__ == '__main__':
    ...
    # python app/read-data-q.py wgawronski-airflow-hybrid-demo period1/temp.csv "select * from customers WHERE country = 'Germany' AND (date BETWEEN '2022-01-01 14:15:55' AND '2022-09-29 10:15:55')" rds-airflow-hybrid eu-central-1
    ...
    # "select * from customers WHERE country = '{country}' AND (date BETWEEN '{start}' AND '{end}')".format(country=country,start=start,end=end)
